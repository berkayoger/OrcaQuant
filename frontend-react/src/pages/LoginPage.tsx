  ...
  return (
    <div className="mx-auto max-w-md space-y-8">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-slate-400">Hesabınıza giriş yaparak panonuza erişin.</p>
      </div>
      <form
      ...
      >
        <div>
          ...
          <input
            ...
            placeholder="ornek@orcaquant.com"
          />
        ...
        <p className="text-center text-sm text-slate-400">
          Hesabınız yok mu?{' '}
          <Link to="/register" className="text-accent hover:text-cyan-400">
            Kayıt olun
          </Link>
        </p>
      </form>
